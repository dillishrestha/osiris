...
namespace osiris
{
	...
	{		
		...
		public string nombre_empresa = "CONTROL DE CLINICA S.C."; //"P R A C T I M E D"; "CONTROL DE CLINICA A.C."
		public string nombre_empresa2 = "CONTROL DE CLINICA";  //"CONTROL DE CLINICA";
		public string direccion_empresa = "Jose Angel Conchello 2880, Col. Victoria"; //"Loma Grande 2703, Col. Loma de San Francisco"; //"Jose Angel Conchello 2880, Col. Victora"
