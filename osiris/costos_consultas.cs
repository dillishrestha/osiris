...
namespace osiris
{
	public class costos_consultas
	{
		...
		{
			if(LoginEmpleado == "ADMIN" || LoginEmpleado == "ROLVEDAFLORES" || LoginEmpleado == "SAMANTHA" ){
	...
	public class consulta_mensual_productos
	{
		...
		public consulta_mensual_productos(string LoginEmp_, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string nombrebd_ )
		{
			LoginEmpleado = LoginEmp_;
    		NomEmpleado = NomEmpleado_;
    		AppEmpleado = AppEmpleado_;
