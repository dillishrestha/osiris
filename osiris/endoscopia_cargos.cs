...
namespace osiris
{
	public class cargos_endoscopia
	{
		...
		public int idtipointernamiento = 710;				// Toma el valor del tipo de internamiento
		public string descripinternamiento = "ENDOSCOPIA";  	// Toma la descripcion del internamiento
		...
		public int idsubalmacen = 10;   // Sub-Almacen de Hospitalizacion
		...
		public cargos_endoscopia(string LoginEmp, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_ ) 
		{
