// created on 12/11/2008 at 12:07 p
...
namespace osiris
{
	public class hemodialisis
	{
		...
		public hemodialisis (string LoginEmp_, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_) 
		{
			...
			menu_hospitalizacion.Title = "Menu de Hemodialisis";
			this.label35.Text = " Menu Hemodialisis ";
		...
		{
			new osiris.cargos_hemodialisis(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd);
		}
		...
		{
			 new osiris.orden_compra_urgencias(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,14,"HEMODIALISIS",0,"");
		}
		
		void on_button_inv_subalmacen_clicked(object sender, EventArgs args)
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,14,"HEMODIALISIS",1);
		}
		
		void on_button_traspaso_subalmacenes_clicked(object sender, EventArgs args)
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,14,"HEMODIALISIS",2);
		}
