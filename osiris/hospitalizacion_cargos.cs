...
//				  Ing. Daniel Olivares (Preprogramacion y Ajustes)
// 				  
// Licencia		: GLP
//////////////////////////////////////////////////////////
//
...
namespace osiris
{
	public class cargos_hospitalizacion
	{
		...
		public int idtipointernamiento = 500;				// Toma el valor del tipo de internamiento
		public string descripinternamiento = "HOSPITALIZACION";  	// Toma la descripcion del internamiento
		...
		public int idsubalmacen = 3;   // Sub-Almacen de Hospitalizacion
		...
		public cargos_hospitalizacion(string LoginEmp, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_ ) 
		{
