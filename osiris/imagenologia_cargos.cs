// created on 09/06/2007 at 12:50 p
///////////////////////////////////////////////////////////
// Hospital Santa Cecilia
// Monterrey - Mexico
//
// Autor    	: Ing. Juan Antonio Peña Gonzalez (Programacion)
//				  Ing. Daniel Olivares (Preprogramacion y actualizaciones)
// 				  
// Licencia		: GLP
//////////////////////////////////////////////////////////
//
...
// 
//////////////////////////////////////////////////////////
// Programa		: cargos_imagenolgia.cs
// Proposito	: Pagos en Caja 
// Objeto		: cargos_imagenologia.cs
//////////////////////////////////////////////////////////	
using System;
using Npgsql;
using System.Data;
...
namespace osiris
{
	public class cargos_imagenologia
	{
		...
		public int idtipointernamiento = 300;					// Toma el valor del tipo de internamiento
		public int idempresa_paciente = 0;						// Toma el valor de la empresa que el hospital tiene convenio
		public string descripinternamiento = "Imagenologia";	// Toma la descripcion del internamiento
		...
		public cargos_imagenologia (string LoginEmp, string NomEmpleado, string AppEmpleado, string ApmEmpleado, string _nombrebd_ ) 
		{
		...
		void crea_treeview_servicio()
		{
			...
			col_precio_hc.PackStart(cellr7, true);
			col_precio_hc.AddAttribute (cellr7, "text", 7);
			...
			col_ppor_cantidad_hc.PackStart(cellr8, true);
			col_ppor_cantidad_hc.AddAttribute (cellr8, "text", 8);
			...
			col_iva_hc.PackStart(cellr9, true);
			col_iva_hc.AddAttribute (cellr9, "text", 9);
			...
			col_sub_total_hc.PackStart(cellr10, true);
			col_sub_total_hc.AddAttribute (cellr10, "text", 10);
			...
			col_por_desc_hc.PackStart(cellr11, true);
			col_por_desc_hc.AddAttribute (cellr11, "text", 11);
			...
			col_valor_desc_hc.PackStart(cellr12, true);
			col_valor_desc_hc.AddAttribute (cellr12, "text", 12);
			...
			col_total_hc.PackStart(cellr13, true);
			col_total_hc.AddAttribute (cellr13, "text", 13);
		...
		{
			//descripcion_producto descrip = (descripcion_producto) model.GetValue (iter, 16);
		...
		void crea_treeview_cargextra()
		{
			...
			//cellr7.Foreground = "white";
			cellr7.CellBackground = "lightgreen";
			////////////////////////////////////////////
			/*
			...
			col_precio.PackStart(cellr8, true);
			col_precio.AddAttribute (cellr8, "text", 8);
			...
			col_ppor_cantidad.PackStart(cellr9, true);
			col_ppor_cantidad.AddAttribute (cellr9, "text", 9);
        
			TreeViewColumn col_iva = new TreeViewColumn();
			CellRendererText cellr10 = new CellRendererText();
			col_iva.Title = "I.V.A."; // titulo de la cabecera de la columna, si está visible
			col_iva.PackStart(cellr10, true);
			col_iva.AddAttribute (cellr10, "text", 10);
			...
			col_sub_total.PackStart(cellr11, true);
			col_sub_total.AddAttribute (cellr11, "text", 11);
			...
			col_por_desc.PackStart(cellr12, true);
			col_por_desc.AddAttribute (cellr12, "text", 12);
			...
			col_valor_desc.PackStart(cellr13, true);
			col_valor_desc.AddAttribute (cellr13, "text", 13);
			...
			col_total.PackStart(cellr14, true);
			col_total.AddAttribute (cellr14, "text", 14);
			*/
        	//////////////////////////////////////////////
		...
		{	
			...
			try{
				...
				comando.CommandText = "SELECT descripcion_producto,to_char(hscmty_erp_cobros_deta.id_producto,'999999999999') AS idproducto, "+
							...
							"AND hscmty_erp_cobros_deta.id_tipo_admisiones = '300' "+//linea para que solo lea los productos aplicados por este departamento
				...
				while (lector.Read()){
					...
					if (!(bool) lector["eliminado"]){
						if((string)lector ["agrupacion"] == "IMG"){
 		...
 		void llenando_lista_de_productos()
 		{
			...
			try{
				...
				comando.CommandText = "SELECT to_char(hscmty_productos.id_producto,'999999999999') AS codProducto,"+
						...
						"AND hscmty_grupo_producto.agrupacion3 = 'IMG' "+
						...
						if ((int) idlugarprocedencia >= 20){
							if ((string) entry_desc_producto.Text.Trim() == ""){}else{
								...
								treeViewEngineExtras.AppendValues (true,//0
													...
													costo_total_producto);//costotprodu.ToString("F").PadLeft(10));//19
								...
								this.entry_cantidad_aplicada.Text = "0";
							}								
						}else{
							MessageDialog msgBoxError = new MessageDialog (MyWinError,DialogFlags.DestroyWithParent,
							MessageType.Error, 
		...
		struct Item
 		{
			...
			public Item (bool col0_car_extr,float col1_car_extr,string col2_car_extr,string col3_car_extr,
					...
					string col13_car_extr,string col14_car_extr,int col15_car_extr,int col16_car_extr,
					string col17_car_extr,string col18_car_extr,string col19_car_extr )
			{
