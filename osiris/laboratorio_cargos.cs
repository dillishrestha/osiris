...
namespace osiris
{
	public class cargos_laboratorio
	{
		...
		ListStore treeViewEngineresultados;
		...
		int idtipointernamiento = 400;					// Toma el valor del tipo de internamiento
		int idempresa_paciente = 0;						// Toma el valor de la empresa que el hospital tiene convenio
		string descripinternamiento = "LABORATORIO";  	// Toma la descripcion del internamiento
