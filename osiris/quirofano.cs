		...
		void imprime_reporte_cirugias(object sender, EventArgs args)
		{
			...
			if(checkbutton_export_to.Active == true){
				string query_sql = "SELECT DISTINCT ON (osiris_erp_pases_qxurg.folio_de_servicio) osiris_erp_pases_qxurg.folio_de_servicio, osiris_erp_pases_qxurg.id_secuencia,osiris_erp_pases_qxurg.folio_de_servicio AS foliodeservicio,to_char(osiris_erp_cobros_enca.pid_paciente,'9999999999') AS pidpaciente," +
						...
						"osiris_erp_cobros_enca.id_medico_tratante,osiris_his_medicos.nombre_medico AS medicotratante,"+
						"osiris_erp_cobros_enca.observaciones1 "+
				...
				string[] args_names_field = {"fechapaseqx","foliodeservicio","pidpaciente","nombre_completo","motivo_ingreso","descripcion_tipo_paciente","descripcion_cirugia","medicotratante","observaciones1"};
				string[] args_type_field = {"string","float","float","string","string","string","string","string","string"};
				// class_crea_ods.cs
