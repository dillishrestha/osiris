...
/*id habitacion*/		"hscmty_erp_cobros_enca.id_habitacion,to_char(hscmty_his_habitaciones.numero_cuarto,'999999999') AS numerocuarto,hscmty_his_habitaciones.descripcion_cuarto,hscmty_his_habitaciones.id_tipo_admisiones AS idtipoadmisiones_habitacion,"+
...
/*id habitacion*/		"hscmty_his_habitaciones, "+
				...
				if(lector.Read())
				{
            		...
            		// Validando que tenga asignada una habitacion   /*id habitacion*/
					...
					if((int) lector["idtipoadmision"] > 16){					
						...
						button_busca_producto.Sensitive = false;
						button_alta_paciente.Sensitive = false; //alta paciente/////////
						MessageDialog msgBoxError = new MessageDialog (MyWinError,DialogFlags.DestroyWithParent,
