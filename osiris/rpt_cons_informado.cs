...
{	
	public class conse_info
	{
		...
		void formato_consentimiento2(Cairo.Context cr,Pango.Layout layout)
		{
			...
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			cr.MoveTo(columna_inicio*escala_en_linux_windows, filatex*escala_en_linux_windows);				layout.SetText("clínicos otorgados por "+classpublic.nombre_empresa2+" practique u  ordene cuanto examen,");
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			cr.MoveTo(columna_inicio*escala_en_linux_windows, filatex*escala_en_linux_windows);				layout.SetText("reconocimiento curación o procedimiento diagnostico y terapeuticos  o");
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			cr.MoveTo(columna_inicio*escala_en_linux_windows, filatex*escala_en_linux_windows);				layout.SetText("quirúrgico sean necesarios. Acepto y  autorizo  al  citado  medico  para");
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			cr.MoveTo(columna_inicio*escala_en_linux_windows, filatex*escala_en_linux_windows);				layout.SetText("que   solicite   interconsulta  a   otro  médico  para  la  atención  de  mi");
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			cr.MoveTo(columna_inicio*escala_en_linux_windows, filatex*escala_en_linux_windows);				layout.SetText("padecimiento o de cualquier consecuencia de mismo aceptando desde");
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			cr.MoveTo(columna_inicio*escala_en_linux_windows, filatex*escala_en_linux_windows);				layout.SetText("ahora todos  y cada  uno  de los  riesgos  inherentes  e  implícitos de la");
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			...
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			cr.MoveTo(columna_inicio*escala_en_linux_windows, filatex*escala_en_linux_windows);				layout.SetText("y a "+classpublic.nombre_empresa2+" a  que  disponga  de  los  órganos  o  tejidos  extirpados");
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			cr.MoveTo(columna_inicio*escala_en_linux_windows, filatex*escala_en_linux_windows);				layout.SetText("para su estudio si así lo consideran necesario.");
			Pango.CairoHelper.ShowLayout (cr, layout);
			filatex += separacion_linea;
			filatex += separacion_linea;
			fontSize = 11.0;
