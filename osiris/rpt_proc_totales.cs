...
namespace osiris
{
	public class proc_totales
	{
		...
		public	int idgrupoproducto = 0;					// el codigo del producto
		...
		public 	decimal deducible = 0;					//es el dedicible de impuestos plicado en la factura
		public 	decimal coaseguro = 0;					//es el valor de coaseguro que se descuenta del total facturado
		...
		public proc_totales ( int PidPaciente_ , int folioservicio_,string _nombrebd_ ,string entry_fecha_admision_,string entry_fechahora_alta_,
        ...
        try{
        	...
        	comando = conexion.CreateCommand ();
           	...
           	comando.CommandText ="SELECT "+
						...
						"to_char(hscmty_erp_cobros_deta.cantidad_aplicada * hscmty_erp_cobros_deta.precio_producto,'9999999.99') AS ppcantidad,"+
