...
namespace osiris
{
	public class terapia_adulto
	{
		...
		[Widget] Gtk.Window menu_terapia_adulto;
		...
		public terapia_adulto (string LoginEmp_, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_) 
		{
			...
			Glade.XML gxml = new Glade.XML (null, "terapia_adulto.glade", "menu_terapia_adulto", null);
			gxml.Autoconnect (this);
			////// Muestra ventana de Glade
			menu_terapia_adulto.Show();
		...
		{
			new osiris.cargos_terapia_adulto (LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd);
		}
		
		void on_button_soli_material_clicked(object sender, EventArgs args)
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,6);
		}
		
		void on_button_autorizacion_medicamento_clicked(object sender, EventArgs args)
		{
			 new osiris.orden_compra_urgencias(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,6,"UNIDAD CUIDADOS INTENSIVOS ADULTOS",0,"");
		}
		
		void on_button_inv_subalmacen_clicked(object sender, EventArgs args)
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,6,"UNIDAD CUIDADOS INTENSIVOS ADULTOS",1);
		}
		
		void on_button_traspaso_subalmacenes_clicked(object sender, EventArgs args)
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,6,"UNIDAD CUIDADOS INTENSIVOS ADULTOS",2);
		}
