...
namespace osiris
{
	public class cargos_terapia_adulto
	{
		...
		public int idempresa_paciente = 0;					// Toma el valor de la empresa que el hospital tiene convenio = 0;
		public int idhabitacion = 0;						// Toma el id de la habitacion asignada
		
		// Toma el valor de la empresa que el hospital tiene convenio
		public int idtipointernamiento = 810;				// Toma el valor del tipo de internamiento
		public string descripinternamiento = "TERAPIA INTENSIVA ADULTO";  	// Toma la descripcion del internamiento
		...
		public int idsubalmacen = 6;   // Sub-Almacen de Terapia Intensiva Adulto
		...
		public cargos_terapia_adulto(string LoginEmp, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_ ) 
		{
