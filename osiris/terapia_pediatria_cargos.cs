...
namespace osiris
{
	public class cargos_terapia_pediatrica
	{
		...
		int idtipointernamiento = 820;				// Toma el valor del tipo de internamiento
		string descripinternamiento = "TERAPIA PEDIATRICA";  	// Toma la descripcion del internamiento
		...
		int idsubalmacen = 8;   // Sub-Almacen de Pediatrica
		...
		public cargos_terapia_pediatrica(string LoginEmp, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string nombrebd_ ) 
		{
