...
namespace osiris
{
	public class cargos_terapia_pediatrica
	{
		...
		public string descripinternamiento = "TERAPIA PEDIATRICA";  	// Toma la descripcion del internamiento
		...
		public int idsubalmacen = 8;   // Sub-Almacen de Pediatrica
		...
		public cargos_terapia_pediatrica(string LoginEmp, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_ ) 
		{
		...
		void llenado_de_productos_aplicados(string foliodeserv)
		{
			...
			try{
				...
				if(lector.Read()){
					...
					if( int.Parse(entry_edad.Text) != 0 && int.Parse(entry_edad.Text) < 14 ) {
