...
namespace osiris
{
	public class tococirugia_ginecologia
	{
		...
		[Widget] Gtk.Window menu_ginecologia;
		...
		public tococirugia_ginecologia (string LoginEmp_, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_) 
		{
			...
			Glade.XML gxml = new Glade.XML (null, "tococirugia_ginecologia.glade", "menu_ginecologia", null);
			gxml.Autoconnect (this);
			////// Muestra ventana de Glade
			menu_ginecologia.Show();
		...
		{
			new osiris.cargos_ginecologia(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd);
		}
		
		void on_button_soli_material_clicked(object sender, EventArgs args)
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,9);
		}
		
		void on_button_autorizacion_medicamento_clicked(object sender, EventArgs args)
		{
			 new osiris.orden_compra_urgencias(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,9,"GINECOLOGIA-TOCOCIRUGIA",0,"");
		}
		
		void on_button_inv_subalmacen_clicked(object sender, EventArgs args)
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,9,"GINECOLOGIA-TOCOCIRUGIA",1);
		}
		
		void on_button_traspaso_subalmacenes_clicked(object sender, EventArgs args)
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,9,"GINECOLOGIA-TOCOCIRUGIA",2);
		}
