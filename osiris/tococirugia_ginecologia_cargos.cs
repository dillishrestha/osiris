...
namespace osiris
{
	public class cargos_ginecologia
	{
		...
		public int idtipointernamiento = 600;				// Toma el valor del tipo de internamiento
		public string descripinternamiento = "GINECOLOGIA-TOCOCIRUGIA";  	// Toma la descripcion del internamiento
		...
		public int idsubalmacen = 9;   // Sub-Almacen de Ginecologia
		...
		public cargos_ginecologia(string LoginEmp, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_ ) 
		{
		...
		{
			if(radiobutton_mejoria.Active == true){causa_de_alta_paciente = " Por Mejoria";}
			//Console.WriteLine(causa_de_alta_paciente);
		}
		void on_radiobutton_evolucion_clicked(object sender, EventArgs args)
		{
			if(radiobutton_mejoria.Active == true){causa_de_alta_paciente = " Por Evolucion";}
			//Console.WriteLine(causa_de_alta_paciente);
		}
		void on_radiobutton_traslado_clicked(object sender, EventArgs args)
		{
			if(radiobutton_mejoria.Active == true){causa_de_alta_paciente = " Por Traslado";}
			//Console.WriteLine(causa_de_alta_paciente);
		}
		void on_radiobutton_voluntaria_clicked(object sender, EventArgs args)
		{
			if(radiobutton_mejoria.Active == true){causa_de_alta_paciente = " Por Voluntaria";}
			//Console.WriteLine(causa_de_alta_paciente);
		}
		void on_radiobutton_no_mejoria_clicked(object sender, EventArgs args)
		{
			if(radiobutton_mejoria.Active == true){causa_de_alta_paciente = " Por NO Mejoria";}
			//Console.WriteLine(causa_de_alta_paciente);
		}
		void on_radiobutton_defuncion_clicked(object sender, EventArgs args)
		{
			if(radiobutton_mejoria.Active == true){causa_de_alta_paciente = " Por Defuncion";}
			//Console.WriteLine(causa_de_alta_paciente);
		}
