...
namespace osiris
{
	public class cargos_ginecologia
	{
		...
		int idtipointernamiento = 600;				// Toma el valor del tipo de internamiento
		string descripinternamiento = "GINECOLOGIA-TOCOCIRUGIA";  	// Toma la descripcion del internamiento
		...
		int idsubalmacen = 9;   // Sub-Almacen de Ginecologia
		...
		public cargos_ginecologia(string LoginEmp, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string nombrebd_ ) 
		{
