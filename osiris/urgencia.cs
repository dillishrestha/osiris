...
namespace osiris
{
	public class urgencia
	{
		...
		[Widget] Gtk.Window menu_urgencia;
		...
		public urgencia (string LoginEmp_, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_) 
		{
			...
			Glade.XML gxml = new Glade.XML (null, "urgencia.glade", "menu_urgencia", null);
