...
namespace osiris
{
	public class cargos_urgencia
	{
		...
		public int idtipointernamiento = 100;				// Toma el valor del tipo de internamiento
		public string descripinternamiento = "URGENCIAS";  	// Toma la descripcion del internamiento
		...
		public int idsubalmacen = 4;   // Sub-Almacen de URGENCIAS
		...
		public cargos_urgencia(string LoginEmp, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string _nombrebd_ ) 
		{
